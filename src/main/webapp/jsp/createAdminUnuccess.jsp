...
<head>
	...
	<script>
		alert("Admin Account Creation Failed! Try Again...");
	</script>
		...
		<div class="createpage">
			...
			<div class="admin-createpanel">
				<form action="<%=request.getContextPath()%>/AdminCreateServlet" method="post">
					...
					<input type="text" name="name" class="createinput"> <br><br>
					...
					<input type="text" name="username" class="createinput"> <br><br>
					<label class="acuname"> Password</label> <br>
					<input type="text" name="password" class="createinput"> <br><br>
